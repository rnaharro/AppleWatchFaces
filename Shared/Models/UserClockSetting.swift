...
class UserClockSetting: NSObject {
    ...
    static var fileName = "userClockSettingsV03.json" //change this if significant schema changes are made and users will lose their data, but wont crash.  Otherwise, make migration code
